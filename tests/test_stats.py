...
def test_record_attempt():
    ...
    stats.record_attempt(mode="A", correct=True, note_name="E", string_index=0)
    stats.record_attempt(mode="A", correct=False, note_name="E", string_index=0)
    stats.record_attempt(mode="A", correct=True, note_name="F#", string_index=1)
